			...
			<CardContent className="p-6">
				<form id={form.id} action={action} onSubmit={form.onSubmit} noValidate>
					...
					<div className="flex flex-col gap-1 mb-6 w-fit">
						<div className="flex gap-4 fitems-center">
					...
					<div className="grid gap-6 mb-6 md:grid-cols-3">
						<div>
							...
							<div className="flex">
								<span className="flex items-center px-3 border-r-0 rounded-md bg-muted">
									#
								</span>
								<Input
					...
					<div>
						...
						<div className="grid grid-cols-12 gap-4 mb-4">
							...
							<div className="col-span-2">
								<Input
									name={fields.invoiceItemPrice.name}
									key={fields.invoiceItemPrice.key}
									type="number"
									placeholder="0"
									value={price}
								...
								/>
								<p className="text-sm text-red-500">
									{fields.invoiceItemPrice.errors}
								</p>
							</div>
							<div className="col-span-2">
								<Input
