import HeroImage from "@/public/hero-invoicer.png";
	...
	return (
		<section className="relative flex flex-col items-center justify-center py-12 lg:py-20">
			<div className="text-center">
				<span className="text-sm text-primary font-medium tracking-light bg-primary/10 px-4 py-2 rounded-full">
					Introducing Invoicer 1.0
				</span>
				...
				<p className="max-w-xl mx-auto mt-4 lg:text-lg text-muted-foreground">
					Creating Invoices can be a pain! We at Invoicer make it super easy for
